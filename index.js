...
const uri = `mongodb+srv://${process.env.USER_NAME}:${process.env.USER_PASS}@cluster0.mowydsq.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    const productCollection = client.db("bistroDB").collection("product");
